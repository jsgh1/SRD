          ...
          <div class="form-group">
            ...
            <div class="foto-actual">
              <?php if ($ruta_foto_persona_bd): ?>
                <img src="<?php echo htmlspecialchars($ruta_foto_persona_bd); ?>" alt="Foto persona">
              <?php else: ?>
          ...
          <div class="form-group">
            ...
            <div class="foto-actual">
              <?php if ($ruta_foto_documento_bd): ?>
                <img src="<?php echo htmlspecialchars($ruta_foto_documento_bd); ?>" alt="Foto documento">
              <?php else: ?>
                <span class="foto-placeholder">Sin imagen</span>
              <?php endif; ?>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="foto-actual">
              <?php if ($ruta_foto_predio_bd): ?>
                <img src="<?php echo htmlspecialchars($ruta_foto_predio_bd); ?>" alt="Foto predio">
              <?php else: ?>
                <span class="foto-placeholder">Sin imagen</span>
              <?php endif; ?>
            </div>
